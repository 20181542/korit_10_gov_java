...
//        double mathscores = 0;
//        for (Student student : studentList) {
//            korscores += student.getKorScore();
//            engscores += student.getEngScore();
//            mathscores += student.getMathScore();
//        }
//        double a = korscores / studentList.size();
//        double b = engscores / studentList.size();
//        double c = mathscores / studentList.size();
//
//        scoreMap.replace("korScore", a);
//        scoreMap.replace("engScore", b);
//        scoreMap.replace("mathScore", c);
//        System.out.println(scoreMap);
        ...
        for (Student student : studentList){
            ...
            scoreMap.replace("engScore", scoreMap.get("engScore") + student.getKorScore());
            scoreMap.replace("mathScore", scoreMap.get("mathScore") + student.getKorScore());
        }
